export default {
  ...
  privacy: {
    ...
    overview: 'whenly erhebt minimale Daten. Umfragen und Stimmen werden nach dem konfigurierten Aufbewahrungszeitraum automatisch gelöscht. Es gibt kein Nutzerkonto, keine Registrierung und kein Login.',
    dataHeading: 'Welche Daten werden gespeichert?',
    data1: 'Beim Erstellen einer Umfrage werden der Titel, optionale Beschreibung, Optionen und Einstellungen gespeichert. Beim Abstimmen werden der eingegebene Name und die Stimme gespeichert. Keine E-Mail-Adressen, keine Passwörter.',
    data2: 'Zur Wiedererkennung (damit du deine Stimme später ändern kannst) wird ein technisches Token im localStorage deines Browsers gespeichert. Es verlässt dein Gerät nur als Teil der API-Anfragen an whenly.de.',
    logsHeading: 'Server-Logs',
    logs: 'Der Webserver speichert beim Aufruf von Seiten technische Zugriffsdaten (IP-Adresse, Zeitstempel, aufgerufene URL, Browser-Kennung). Diese Logs werden nach 14 Tagen automatisch gelöscht und nicht für Werbezwecke verwendet. Rechtsgrundlage: Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse an Betrieb und Sicherheit des Dienstes).',
    cookiesHeading: 'Cookies',
    cookies: 'whenly setzt keine Tracking-Cookies. Der Browser-localStorage wird ausschließlich für das Teilnehmer-Token genutzt.',
    adsHeading: 'Werbung (Google AdSense)',
    ads1: 'Auf dieser Website wird Google AdSense eingesetzt, ein Dienst der Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland. Wir verwenden Google AdSense ausschließlich im Modus für nicht-personalisierte Anzeigen - es werden keine Nutzungsprofile erstellt und keine Cookies für Werbezwecke gesetzt.',
    ads2: 'Dabei können technische Daten (z. B. IP-Adresse, Browser-Informationen) an Google-Server übertragen werden. Die Übertragung erfolgt auf Grundlage der Standardvertragsklauseln der EU-Kommission. Rechtsgrundlage: Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse an der Finanzierung des kostenlosen Dienstes).',
    ads3: 'Da ausschließlich nicht-personalisierte Anzeigen geschaltet werden, ist kein Cookie-Consent erforderlich. Google erhält keine Daten, die eine persönliche Identifikation ermöglichen.',
    ads4: 'Datenschutzerklärung von Google: ',
    ads5: 'Weitere Informationen zu nicht-personalisierten Anzeigen: ',
    retentionHeading: 'Datenspeicherung und Löschung',
    retention: 'Umfragen werden standardmäßig 30 Tage nach dem letzten Termin-Slot gelöscht, maximal nach 365 Tagen. Der Ersteller kann den Zeitraum beim Anlegen konfigurieren. Es gibt keine manuelle Löschfunktion - die Daten verschwinden automatisch.',
    rightsHeading: 'Deine Rechte',
    rights: 'Du hast das Recht auf Auskunft, Berichtigung und Löschung deiner Daten (Art. 15-17 DSGVO). Da whenly keine Benutzerkonten führt und Daten anhand anonymer Tokens gespeichert werden, ist eine Zuordnung zu einer Person nur mit dem jeweiligen Token möglich. Kontaktiere uns mit deinem Token für entsprechende Anfragen.',
