export default {
  ...
  privacy: {
    ...
    overviewHeading: 'Privacy at a glance',
    overview: 'whenly collects minimal data. Polls and votes are deleted automatically after the configured retention window. There are no user accounts, no registration and no login.',
    dataHeading: 'What data is stored?',
    data1: 'When creating a poll, the title, optional description, options and settings are stored. When voting, the entered name and vote are stored. No email addresses, no passwords.',
    data2: 'To recognize you later (so you can update your vote), a technical token is stored in your browser\'s localStorage. It only leaves your device as part of API requests to whenly.de.',
    logsHeading: 'Server logs',
    logs: 'The web server records technical access data when pages are accessed (IP address, timestamp, requested URL, browser identifier). These logs are automatically deleted after 14 days and are not used for advertising purposes. Legal basis: Art. 6(1)(f) GDPR (legitimate interest in operating and securing the service).',
    cookiesHeading: 'Cookies',
    cookies: 'whenly does not set tracking cookies. The browser localStorage is used exclusively for the participant token.',
    adsHeading: 'Advertising (Google AdSense)',
    ads1: 'This website uses Google AdSense, a service of Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Ireland. We use Google AdSense exclusively in non-personalized ads mode - no user profiles are created and no cookies are set for advertising purposes.',
    ads2: 'Technical data (e.g. IP address, browser information) may be transmitted to Google servers. The transmission is based on the EU Commission\'s standard contractual clauses. Legal basis: Art. 6(1)(f) GDPR (legitimate interest in financing the free service).',
    ads3: 'Since only non-personalized ads are served, no cookie consent is required. Google does not receive data that enables personal identification.',
    ads4: 'Google\'s Privacy Policy: ',
    ads5: 'More information on non-personalized ads: ',
    retentionHeading: 'Data retention and deletion',
    retention: 'Polls are deleted by default 30 days after the last date slot, at most after 365 days. The creator can configure the period when creating. There is no manual deletion function - the data disappears automatically.',
    rightsHeading: 'Your rights',
    rights: 'You have the right to access, rectification and deletion of your data (Art. 15-17 GDPR). Since whenly does not maintain user accounts and data is stored using anonymous tokens, assignment to a person is only possible with the respective token. Contact us with your token for corresponding requests.',
